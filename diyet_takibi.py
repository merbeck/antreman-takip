...
if yemek_adi:
    filtreli = yemekler_df[yemekler_df['yemek_adi'].str.contains(yemek_adi, case=False, na=False)]
else:
    filtreli = yemekler_df.copy()

if not filtreli.empty:
    secim = st.selectbox("Yemek seçin:", filtreli['yemek_adi'].unique())
